...
export const SAMPLE_MENU: MenuItem[] = [
  ...
  { id: 'm24', name: 'Vada Pav', category: 'fastfood', description: "Mumbai's iconic street burger with spiced potato fritter", tags: ['veg', 'vegan'], spiceLevel: 2, upvotes: 118, downvotes: 4, imageEmoji: '🍔', day: 3, userVote: null },
];
